<template>
    ...
    <!--<div class="nav-bar active">-->
        <div class="menu-btn">
            <!--<i class="fa fa-navicon  fa-3x nav-icon" ></i>
            <i class="fa fa-caret-right fa-2x nav-icon" v-show="!isActive"></i>
            <i class="fa fa-caret-down fa-2x nav-icon" v-show="isActive"></i>-->
        ...
        <div class="nav-link">
            ...
            <a href="#" class="">Presskit Download</a>
            <a href="#" class="">Multiverse</a>
        </div>
    </div>
</template>
